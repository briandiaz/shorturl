...
<%@page import="shorturl.entities.Role"%>
...
<%
    ...
    List<Role> roles = PersistenceJPA.getSingletonInstance().getListaRole();
                                    ...
                                    <table class="table table-bordered" id="table-sortable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control select-role" data-user="<%= user.getId() %>">
                                                        <% for (Role role : roles) {%>
                                                        <option value="<%= role.getId()%>" 
                                                                <%if(user.getRole().getId().equals(role.getId())){%>selected<%}%>><%= role.getName()%></option>
                                                        <%}%>
                                                    </select>
                                                </td>
                                            </tr>
